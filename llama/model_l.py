...
# from llama.generation_l import Generation
from llama.layers import LoRALayer, Linear
...
class Attention(nn.Module):
    ...
    def __init__(self, args: ModelArgs):
        ...
        self.wq = Linear(args.dim, args.n_heads * self.head_dim, r=16, lora_alpha=32, lora_dropout=0.05)
        # self.wq = nn.Linear(args.dim, args.n_heads * self.head_dim, bias=False)
        # self.wk = nn.Linear(args.dim, self.n_kv_heads * self.head_dim, bias=False)
        self.wk = Linear(args.dim, self.n_kv_heads * self.head_dim, r=16, lora_alpha=32, lora_dropout=0.05)
        self.wv = Linear(args.dim, self.n_kv_heads * self.head_dim, r=16, lora_alpha=32, lora_dropout=0.05)
...
class FeedForward(nn.Module):
    ...
    def forward(self, x):
        ...
        # return self.w2(checkpoint(self._forward, x))
...
class TransformerBlock(nn.Module):
    ...
    def forward(
        ...
        # h = checkpoint(self._forward, x, freqs_cis, mask)
...
class Transformer(nn.Module): 
    #Original: class Llama(Generation)
